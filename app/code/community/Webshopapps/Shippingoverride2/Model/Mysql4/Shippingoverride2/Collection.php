 ...
 * @package    Webshopapps_Priceweight
 * @copyright   Copyright (c) 2013 Zowta Ltd (http://www.WebShopApps.com)
 *              Copyright, 2013, Zowta, LLC - US license
 * @license    http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 * @author     Karen Baker <enquiries@webshopapps.com>
*/
class Webshopapps_Shippingoverride2_Model_Mysql4_Carrier_Shippingoverride2_Collection extends Varien_Data_Collection_Db
{
    ...
    public function __construct()
    {
        ...
        $this->_shipTable = Mage::getSingleton('core/resource')->getTableName('shippingoverride2/shippingoverride2');
