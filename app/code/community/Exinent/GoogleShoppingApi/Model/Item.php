 ...
 * @package    Exinent_GoogleShoppingApi
 */
class Exinent_GoogleShoppingApi_Model_Item extends Mage_Core_Model_Abstract
{
    /**
     ...
     *
     * @var Exinent_GoogleShoppingApi_Model_Service_Item
     */
     ...
     *
     * @return Exinent_GoogleShoppingApi_Model_Service_Item
     */
     ...
     *
     * @param Exinent_GoogleShoppingApi_Model_Service_Item $service
     * @return Exinent_GoogleShoppingApi_Model_Item
     */
    ...
    public function getGoogleShoppingItemId() {
		$tmpId = urldecode($this->getGcontentItemId());
                Mage::log($tmpId,1,'googleapi.log');
