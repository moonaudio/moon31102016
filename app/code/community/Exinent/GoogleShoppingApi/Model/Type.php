 ...
 * @package    Exinent_GoogleShoppingApi
 */
class Exinent_GoogleShoppingApi_Model_Type extends Mage_Core_Model_Abstract
{
    /**
     * Mapping attributes collection
     *
     * @var Exinent_GoogleShoppingApi_Model_Mysql4_Attribute_Collection
     */
     ...
     *
     * @param string $name
     * @return Exinent_GoogleShoppingApi_Model_Attribute
     */
