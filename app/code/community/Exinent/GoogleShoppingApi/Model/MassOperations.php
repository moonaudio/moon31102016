 ...
 * @package    Exinent_GoogleShoppingApi
 */
class Exinent_GoogleShoppingApi_Model_MassOperations
{
    /**
     ...
     *
     * @var Exinent_GoogleShoppingApi_Model_Flag
     */
    protected $_flag;
     ...
     *
     * @param Exinent_GoogleShoppingApi_Model_Flag $flag
     * @return Exinent_GoogleShoppingApi_Model_MassOperations
     */
    public function setFlag(Exinent_GoogleShoppingApi_Model_Flag $flag)
    {
        $this->_flag = $flag;
        return $this;
    }
        ...
        if (is_array($productIds)) {
            foreach ($productIds as $productId) {
                ...
                try {
                    ...
                    Mage::logException($e,'1','googleapi.log');
     ...
     *
     * @param array|Exinent_GoogleShoppingApi_Model_Resource_Item_Collection $items
     * @throws Zend_Gdata_App_CaptchaRequiredException
     * @throws Mage_Core_Exception
     * @return Exinent_GoogleShoppingApi_Model_MassOperations
     */
            ...
            foreach ($itemsCollection as $item) {
                ...
                try {
					if($removeInactive && ($item->getProduct()->isDisabled() || !$item->getProduct()->getStockItem()->getIsInStock() )) {
						...
						$item->delete();
						$totalDeleted++;
						Mage::log("remove inactive: ".$item->getProduct()->getSku()." - ".$item->getProduct()->getName(),'1','googleapi.log');
					} else {
						$item->updateItem();
						$item->save();
     ...
     * @param array|Exinent_GoogleShoppingApi_Model_Resource_Item_Collection $items
     * @throws Mage_Core_Exception
     * @return null|Exinent_GoogleShoppingApi_Model_Resource_Item_Collection
     */
    protected function _getItemsCollection($items)
    {
        $itemsCollection = null;
        if ($items instanceof Exinent_GoogleShoppingApi_Model_Resource_Item_Collection) {
