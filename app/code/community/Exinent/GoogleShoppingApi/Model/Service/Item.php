 ...
 * @package     Exinent_GoogleShoppingApi
 */
class Exinent_GoogleShoppingApi_Model_Service_Item extends Exinent_GoogleShoppingApi_Model_Service
{
    /**
     ...
     *
     * @param Exinent_GoogleShoppingApi_Model_Item $item
    ...
    {
        Mage::log($item->getGoogleShoppingItemId(),1,'googleapi.log');
        $gItemId = $item->getGoogleShoppingItemId();
        $service = Mage::getModel('googleshoppingapi/googleShopping');
