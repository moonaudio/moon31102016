 ...
 * 
*/
class Exinent_GoogleShoppingApi_Adminhtml_GoogleShoppingApi_OauthController extends Mage_Adminhtml_Controller_Action
{ 
	/**
	...
	public function authAction() {
		...
		$client->setApplicationName(Exinent_GoogleShoppingApi_Model_GoogleShopping::APPNAME);
