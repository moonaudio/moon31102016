 ...
 * @package    RocketWeb_GoogleBaseFeedGenerator
 */
class RocketWeb_GoogleBaseFeedGenerator_Block_Adminhtml_System_Config_Form_Field_Mapproductcolumns
    extends RocketWeb_GoogleBaseFeedGenerator_Block_Adminhtml_System_Config_Form_Field_Mapcolumns
{
    ...
    public function configToJson()
    {
        ...
        if ($configs != null && is_array($configs) && count($configs) > 0) {
            foreach ($configs as $config) {
                ...
                if (isset($directives[$attribute]) && isset($directives[$attribute]['source_model']) && $directives[$attribute]['source_model'] != 'googlebasefeedgenerator/source_directive_helper') {
