...
//                $payquote = Mage::getModel('sales/quote')->load($this->_getQuote()->getId());
//                $payquote->getShippingAddress()->delete();
//                $payquotec = Mage::getModel('sales/quote')->load($this->_getQuote()->getId());
//                $payquotec->setTotalsCollectedFlag(false);
//                $payquotec->getShippingAddress()->collectTotals();
//                $payquotec->collectTotals();
//                $payquote->getPayment()->delete();
//                $payquotec->save();
    ...
    public function returnAction()
    {
        ...
        try {
            ...
            $payquote = $this->_quote->getPayment();
            $payquote->setAdditionalInformation($button)->save();
